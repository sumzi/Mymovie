...
import { Row, Input, AutoComplete } from 'antd';
import 'antd/dist/antd.css';
import { Header, InputWrapper, Wrapper, SearchWrapper,IndexWrapper } from './Search.styled';
...
function Search() {
  ...
  return (
    <Wrapper>
      <Header>
          <InputWrapper>
            <input placeholder="Search movie title..." value={word} onChange={onChange} />
          </InputWrapper>
          <IndexWrapper>
            <Row>
              {movies.map((movie, i) => (
